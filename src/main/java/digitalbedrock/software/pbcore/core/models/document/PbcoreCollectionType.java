 ...
 *                 collection.
 * 
 * <p>Java class for pbcoreCollectionType complex type.
 * 
...
public class PbcoreCollectionType {
     ...
     * This is why there is not a <CODE>set</CODE> method for the pbcoreDescriptionDocument property.
     * 
     * <p>
    ...
    public List<PbcoreDescriptionDocumentType> getPbcoreDescriptionDocument() {
        if (pbcoreDescriptionDocument == null) {
            pbcoreDescriptionDocument = new ArrayList<PbcoreDescriptionDocumentType>();
        }
